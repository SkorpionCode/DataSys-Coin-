...
class Blockchain:
    ...
    def new_transaction(self, sender, receiver, amount, new_balance_for_sender_key, new_balance_for_receiver_key):
        transaction = {
            'sender': sender,
            'receiver': receiver,
            'amount': amount,
            'new_balance_for_receiver_key': new_balance_for_receiver_key,
            'new_balance_for_sender_key': new_balance_for_sender_key,
        }
